...
class Companion:
    ...
    def __init_wpa_supplicant(self):
        print('[*] Running Ratul wpa_supplicant…')
...
class WiFiScanner:
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        print('{:<4} {:<18} {:<25} {:<8} {:<4} {:<27} {:<}'.format(
            '#', 'BSSID', 'ESSID', 'Ratul.', 'PWR', 'WSC device name', 'WSC model'))
    ...
    def prompt_network(self) -> str:
        ...
        if not networks:
            print('[-] No WPS networks found - Thnx Ratul.')
            return
        while 1:
            try:
                networkNo = input('Select target (press Enter for Ratul): ')
