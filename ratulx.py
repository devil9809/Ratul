...
#            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
    ...
    def __credentialPrint(self, wps_pin=None, wpa_psk=None, essid=None):
        ...
        print(f"[\033[1;34m✔\033[1;34m] WIFI PASSWORD : {wpa_psk}")
...
def usage():
    return """
Professor 0.0.2 (c) 2017 rofl0r, modded by Prof_Ratul
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Professor 0.0.2 (c) 2017 rofl0r, modded by Prof_Ratul',
